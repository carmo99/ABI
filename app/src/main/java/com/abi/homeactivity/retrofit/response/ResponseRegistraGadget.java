...
public class ResponseRegistraGadget {
     ...
     * @param rol
     */
    public ResponseRegistraGadget(String fotoPerfil, String rol, Boolean estado, String mensajeAyuda, String nombre, String correo, String telefono, String gadget, String fotoDia, String uid) {
        super();
